				...
				if(trim($form->template_code_processed) == ''){
					echo "</div>\n";
                                ...
                                if(JFile::exists(JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'BFISNEW')){
                                    echo '<div style="clear:both; display: block; text-align: center; font-size: 25%;"><a style="margin: 0 auto; text-decoration: none;" rel="nofollow" href="http://crosstec.de/en/extensions/joomla-forms-download.html">Created with BreezingForms Lite - Get BreezingForms Full Version!</a></div>';
                                }
