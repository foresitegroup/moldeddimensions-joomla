...
foreach (JModuleHelper::getModules('bc') as $module)
...
?>
  ...
  <div class="itemBody">
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  		<img align="left" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:100%; max-width:500px; height:auto;" />
		  	</a>
		  </span>
	  ...
	  <?php endif; ?><hr style="margin-top:20px;border:1px #999 dotted;">
